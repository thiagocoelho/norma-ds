...
const MountedPortal = React.memo(({ children, container }: { children: React.ReactNode; container: Element }) => {
...
function usePortal(props: PortalProps = {}) {
  ...
  const WaitMountPortal = useCallback(props => <MountedPortal container={rootElement} {...props} />, [rootElement]);
